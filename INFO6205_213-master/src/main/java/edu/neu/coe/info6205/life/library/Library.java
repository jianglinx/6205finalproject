...
import edu.neu.coe.info6205.life.base.Chromosome;
...
public class Library {
		...
		final public static String Glider3 = "0 0, 1 0, 2 0, 2 1, 1 2";
                ...
                public static List<Point> result= Chromosome.createPoints(Chromosome.createCase()); 
                final public static String abc=result.toString().replace("{", Block).replace("}", Block).replace(",", Block).replace("[", Block).replace("]", Block);
